...
export const UnlockPortalSection = ({ upiId = "9398724704@ybl" }) => {
  ...
  return (
    <section className="py-20 px-6 bg-slate-50 border-t border-slate-200 overflow-hidden">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="bg-slate-900 rounded-[3rem] p-8 md:p-12 shadow-2xl relative overflow-hidden border border-white/5"
        >
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
                ...
                <ul className="space-y-3 text-white/50 text-xs font-bold uppercase tracking-wide">
                    <li className="flex items-center gap-3"><Zap size={14} className="text-cyan-400"/> Choose your Package</li>
                    <li className="flex items-center gap-3"><Cpu size={14} className="text-cyan-400"/> Neural Node Allocation</li>
                    <li className="flex items-center gap-3"><Smartphone size={14} className="text-cyan-400"/> Pay via Secure QR</li>
                    <li className="flex items-center gap-3"><Fingerprint size={14} className="text-cyan-400"/> UTR Authenticator</li>
                    <li className="flex items-center gap-3"><ShieldCheck size={14} className="text-cyan-400"/> Full Unlock Access</li>
                </ul>
            </div>

            <div className="bg-white/5 backdrop-blur-md p-8 rounded-[2rem] border border-white/10 min-h-[350px] flex flex-col justify-center">
