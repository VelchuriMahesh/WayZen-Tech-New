...
import { collection, addDoc, getDocs, deleteDoc, doc, updateDoc } from 'firebase/firestore'; // Removed unused query, orderBy
import { motion, AnimatePresence } from 'framer-motion';
import { 
  LogOut, Plus, Trash2, Edit2, Users, Briefcase, 
  Save, Upload, Loader2, MessageSquare
} from 'lucide-react'; // Removed unused X, Mail, Calendar, User, LinkIcon, Globe
...
export const AdminDashboard = () => {
  ...
  // Wrapped in useCallback to fix dependency warning and prevent infinite loops
  ...
  useEffect(() => {
    ...
    return () => unsubscribe();
  }, [user, fetchData]); // fetchData is now a stable dependency
